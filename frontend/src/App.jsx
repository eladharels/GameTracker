...
import './App.css'
import { FaSearch, FaBook, FaUsers, FaSignOutAlt, FaLock, FaCog, FaRegCalendarAlt, FaPlay, FaHeart, FaCheck, FaTh, FaList, FaTrash, FaExclamationCircle, FaShareAlt, FaSync, FaArrowUp, FaGamepad, FaGripVertical, FaExpand, FaCompress, FaUser, FaServer, FaCode, FaChartBar, FaHourglassHalf } from 'react-icons/fa'
